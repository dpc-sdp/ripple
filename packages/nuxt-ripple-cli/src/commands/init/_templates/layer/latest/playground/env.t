...
# If the value is a constant that does not need to chnage per environment, consider using app.config.ts instead - https://nuxt.com/docs/guide/directory-structure/app-config
