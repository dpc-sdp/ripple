Feature: Embedded Media
  ...
  Scenario: BE - Create media
    ...
    And in the backend there is a node at "/embedded-video-test" with "modules/media/embedded-video-test" data
    And in the backend there is a node at "/test-embedded-video" with "modules/media/embedded-video" data
    And in the backend there is a node at "/test-embedded-video-no-transcript" with "modules/media/embedded-video-no-transcript" data
