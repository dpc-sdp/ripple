...
import RplIcon from '@/components/icon/RplIcon.vue'
import RplExpandable from '@/components/expandable/RplExpandable.vue'
...
import { RplAccordionItemProps } from '@dpc-sdp/ripple-ui-shared/contracts'

const props = defineProps<RplAccordionItemProps>()
