...
<template>
  <div :class="`rpl-layout rpl-layout--${background}`">
    ...
    <header v-if="$slots.primaryNav" id="rpl-header" class="rpl-layout__header">
      ...
      <div v-if="$slots.breadcrumbs" id="rpl-below-header" class="rpl-u-margin-t-1">
        <slot name="breadcrumbs"></slot>
      </div>
    </header>
    <section v-if="$slots.aboveBody" id="rpl-above-body" class="rpl-u-margin-t-1">
    ...
    <div class="rpl-layout__body-wrap">
      <div class="rpl-container">
        <div class="rpl-grid rpl-layout__body">
          ...
          <aside v-if="$slots.sidebar" id="rpl-sidebar" class="rpl-col-3-l rpl-col-12">
            <slot name="sidebar">
            </slot>
          </aside>
        </div>
