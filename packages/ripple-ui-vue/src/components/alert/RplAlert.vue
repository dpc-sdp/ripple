...
import { RplIconNames } from '@/components/icon/constants'
import RplIcon from '@/components/icon/RplIcon.vue'
import RplTextLink from '@/components/text-link/RplTextLink.vue'
...
<style src="@dpc-sdp/ripple-ui-styles/components/alert/RplAlert.css" />
