Feature: Grant page
  ...
  Scenario: BE - Create TC-9a Grant
    ...
    And in the backend there is a node at "/tc-9a-grant" with "grant/TC-9a-grant" data
    And in the backend there is a node at "/tc-9b-grant" with "grant/TC-9b-grant" data
