const themes = {
  ...
  "docsTheme1": {
    ...
    "tokens": {
      ...
      "rpl-clr-gradient-vertical": "linear-gradient(180deg, #EF4A81 0%, #F592B3 40%, #FEE97C 65%, #FDDA24 80%)",
  ...
  "docsTheme3": {
    ...
    "tokens": {
      ...
      "rpl-clr-type-focus-contrast": "var(--rpl-clr-light)",
      "rpl-clr-gradient-vertical": "linear-gradient(180deg, #723036 6.73%, #C03F3A 20.79%, #E8AC82 35.89%, #98C2C6 59.33%, #72A69B 74.96%)",
      "rpl-clr-gradient-horizontal": "linear-gradient(90deg, #723036 6.73%, #C03F3A 20.79%, #E8AC82 35.89%, #98C2C6 59.33%, #72A69B 74.96%)",
      "rpl-clr-type-primary-contrast": "var(--rpl-clr-dark)",
      "rpl-clr-type-primary-contrast-alpha": "rgb(26 26 26 / 0.75)",
      "rpl-clr-type-accent-contrast": "var(--rpl-clr-dark)",
      "rpl-clr-type-primary-accessible": "var(--rpl-clr-type-default)",
