...
export const Template = (args, { argTypes }) => ({
  ...
  template: `
    <rpl-site-header
      ...
      :overridePrimaryLogo="overridePrimaryLogo"
      :deoptimizeContrast="deoptimizeContrast"
    />
  `
});
...
<Canvas>
  <Story
    ...
    args={{
                ...
                { text: 'Sub child IV', url: '#' },
                {
                  ...
                  children: [
                    ...
                    { text: 'Sub child Y', url: '#' },
                    {
                      ...
                      url: '#',
                      children: [
                        { text: 'Level 4 item I', url: '#' },
                        { text: 'Level 4 item II', url: '#' },
                        { text: 'Level 4 item III', url: '#' }
                      ]
                    }
                  ]
                },
      ...
      showSearch: false,
      showLogout: false,
      overridePrimaryLogo: false,
      deoptimizeContrast: false
    }}
  >
    {Template.bind({})}
  </Story>
...
<Canvas>
  <Story
    name="Vicpol Primary Logo (blurry)"
    height= "170px"
    args={{
      logo: {
        alt: 'vic.gov.au',
