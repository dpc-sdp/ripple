...
import { getColorSwatches, getColorSwatch, default as rplColors } from './colors'
...
<Canvas columns={2}>
  <Story
    ...
    args={{
      columns: ['Primary'],
      items: getColorSwatches('clr.primary')
    }}
  >
    {Template.bind({})}
  </Story>
  <Story
    ...
    args={{
      columns: ['Accent'],
      items: getColorSwatches('clr.accent')
    }}
  >
    {Template.bind({})}
  </Story>
...
<Canvas>
  <Story
    ...
    args={{
      columns: ['Neutrals'],
      items: getColorSwatches('clr.neutral')
    }}
  >
    {Template.bind({})}
  </Story>
...
<Canvas>
  <Story
    ...
    args={{
      columns: ['Info'],
      items: [getColorSwatch('clr.information')]
    }}
  >
    {Template.bind({})}
  </Story>
  <Story
    ...
    args={{
      columns: ['Success'],
      items: [getColorSwatch('clr.success')]
    }}
  >
    {Template.bind({})}
  </Story>
  <Story
    ...
    args={{
      columns: ['Warning'],
      items: [getColorSwatch('clr.warning')]
    }}
  >
    {Template.bind({})}
  </Story>
  <Story
    ...
    args={{
      columns: ['Error'],
      items: [getColorSwatch('clr.error'), getColorSwatch('clr.error-alt')]
    }}
  >
    {Template.bind({})}
  </Story>
