export default {
  links: {
    self: {
      href: 'https://develop.content.reference.sdp.vic.gov.au/api/v1/node/tide_search_listing/7b600187-a46a-4e32-becb-978bfe047ba0?resourceVersion=id%3A383'
    }
  },
  meta: {},
  drupal_internal__nid: 289,
  drupal_internal__vid: 383,
  langcode: 'en',
  revision_timestamp: '2024-03-17T21:41:51+00:00',
  revision_log: null,
  status: true,
  title: 'TEST: SLU',
  created: '2024-03-17T21:41:51+00:00',
  changed: '2024-03-17T21:41:51+00:00',
  promote: true,
  sticky: false,
  ...
  metatag: [
    {
      ...
      attributes: {
        name: 'title',
        content: 'TEST: SLU | Single Digital Presence Content Management System'
      }
    },
    {
      tag: 'link',
      attributes: {
        rel: 'canonical',
        href: 'https://develop.content.reference.sdp.vic.gov.au/test-slu'
      }
    },
    {
      tag: 'meta',
  ...
  path: { alias: '/site-8888/test-slu', pid: 1998, langcode: 'en' },
  ...
  field_metatags: null,
  field_search_configuration: null,
  ...
  field_listing_global_filters: [
    {
      links: {
        self: {
          href: 'https://develop.content.reference.sdp.vic.gov.au/api/v1/paragraph/listing_content_type/5bcce0cb-1985-4918-a4a2-b6b4aea063f2?resourceVersion=id%3A2306'
        }
      },
      meta: {
        target_revision_id: 2306,
        drupal_internal__target_id: 1913
      },
      drupal_internal__id: 1913,
      drupal_internal__revision_id: 2306,
      langcode: 'en',
      status: true,
      ...
      id: '5bcce0cb-1985-4918-a4a2-b6b4aea063f2',
      type: 'paragraph--listing_content_type'
    },
    {
      links: {
        self: {
          href: 'https://develop.content.reference.sdp.vic.gov.au/api/v1/paragraph/listing_custom_filter/89f2ff98-657a-40f9-988a-54e9f7cdd72a?resourceVersion=id%3A2307'
        }
      },
      meta: {
        target_revision_id: 2307,
        drupal_internal__target_id: 1914
      },
      drupal_internal__id: 1914,
      drupal_internal__revision_id: 2307,
      langcode: 'en',
      status: true,
      ...
      id: '89f2ff98-657a-40f9-988a-54e9f7cdd72a',
  ...
  field_listing_user_filters: [
    {
      links: {
        self: {
          href: 'https://develop.content.reference.sdp.vic.gov.au/api/v1/paragraph/searchable_fields/9aaedfc7-2b83-4a74-be7a-6d1a66a02577?resourceVersion=id%3A2308'
        }
      },
      meta: {
        target_revision_id: 2308,
        drupal_internal__target_id: 1915
      },
      drupal_internal__id: 1915,
      drupal_internal__revision_id: 2308,
      langcode: 'en',
      status: true,
      ...
      id: '9aaedfc7-2b83-4a74-be7a-6d1a66a02577',
      type: 'paragraph--searchable_fields'
    },
    {
      links: {
        self: {
          href: 'https://develop.content.reference.sdp.vic.gov.au/api/v1/paragraph/listing_user_custom_filter/2e35bb71-3fbe-41d5-b705-d9809ec6bd45?resourceVersion=id%3A2309'
        }
      },
      meta: {
        target_revision_id: 2309,
        drupal_internal__target_id: 1916
      },
      drupal_internal__id: 1916,
      drupal_internal__revision_id: 2309,
      langcode: 'en',
      status: true,
      ...
      id: '2e35bb71-3fbe-41d5-b705-d9809ec6bd45',
  ...
  field_tags: [],
  id: '7b600187-a46a-4e32-becb-978bfe047ba0',
