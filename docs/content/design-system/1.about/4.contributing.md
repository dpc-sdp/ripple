...
- Fill out the [bug report issue template](https://github.com/dpc-sdp/ripple/issues/new?labels=bug&template=bug_report.yml&title=[BUG])
...
- Log in to GitHub
- [Log an issue on the GitHub Repository](https://github.com/dpc-sdp/ripple/issues/new?labels=docs&template=docs.yml&title=[DOCS])
...
- If you are confident that the feature is something worth progressing, please fill out the [New feature proposal](https://github.com/dpc-sdp/ripple/issues/new?labels=bug&template=feature-request.yml&title=[PROPOSAL])
