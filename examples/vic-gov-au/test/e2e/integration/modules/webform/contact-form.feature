Feature: Contact form
  ...
  Scenario: Submit a contact form - success
    Given I stubbed the form "connect_with_us" response with "modules/webforms/contact-us-form-success" fixture
  ...
  Scenario: Submit a contact form - submission failure
    Given I stubbed the form "connect_with_us" response with "modules/webforms/contact-us-form-failure" fixture
    And I visit the page "/contact-us"
    And i enter the following information into the form "form-connect_with_us":
      | label                               | value                     | type       |
      | What type of enquiry do you have?   | General enquiry           | rpl-select |
  ...
  Scenario: Submit a contact form - validation
    Given I stubbed the form "tide_webform_contact_us" response with "modules/webforms/contact-us-form-failure" fixture
    And I visit the page "/contact-us"
