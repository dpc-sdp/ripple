...
export const dynamicDate = new Date();
export const customStartDate = new Date(dynamicDate.setDate(dynamicDate.getDate() - 3)).toUTCString();
export const customEndDate = new Date(dynamicDate.setDate(dynamicDate.getDate() + 10)).toUTCString();
