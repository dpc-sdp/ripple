    ...
    args={{
      ...
      <figure class="rpl-file">
        <a
         ...
         target="_blank">
          <span class="rpl-icon rpl-icon--size-l rpl-icon--colour-default rpl-icon--icon-document-lined">
            <svg role="presentation"><use xlink:href="#icon-document-lined"></use></svg>
          </span>
          <div class="rpl-file__info">
            <span class="rpl-file__name rpl-type-p rpl-type-weight-bold rpl-u-focusable-line" tabindex="0">This is an example of a document title</span>
      ...
      <figure class="rpl-file">
        <a
         ...
         target="_blank">
          ...
          <div class="rpl-file__info">
            <span class="rpl-file__name rpl-type-p rpl-type-weight-bold rpl-u-focusable-inline" tabindex="0">This is an example of a document title</span>
            <div class="rpl-file__meta rpl-type-label-small">
              <span class="rpl-file__type">PDF</span>
              <span class="rpl-file__size">1.5 mb</span>
        ...
        <figcaption v-if="caption" class="rpl-file__caption rpl-type-p-small">
