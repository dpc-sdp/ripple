...
import RplPrimaryNav from './../primary-nav/primary-nav.vue'
...
import { primaryNavItems, verticalNavItems } from './storydata.ts'
...
export const PageLayoutNavigationTemplate = (args) => ({
  ...
  setup() {
    ...
    return { args, primaryNavItems, RplNavCard, img }
  },
  template: `
    <RplLayout v-bind="args">
      <template #primaryNav>
