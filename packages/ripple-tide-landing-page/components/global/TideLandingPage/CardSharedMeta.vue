<template>
  ...
  <span v-if="isGrant && grantStatus" class="rpl-card__status">
    ...
    " class="rpl-icon--colour-success" name="icon-check-circle-filled" />
    <RplIcon v-else class="rpl-icon--colour-error" name="icon-cancel-circle-filled" />
...
const formattedDate = computed(() => {
  if (props.meta.dateStart && props.meta.dateEnd) {
    return formatDateRange(props.meta.dateStart, props.meta.dateEnd)
