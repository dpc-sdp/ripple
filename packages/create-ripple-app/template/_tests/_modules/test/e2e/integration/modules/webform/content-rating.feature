Feature: Content rating form
  ...
  Scenario: Submit a content rating form - success
    Given I stubbed the form "tide_webform_content_rating" response with "modules/webform/content-rating-form-success" fixture
  ...
  Scenario: Submit a content rating form - failure
    Given I stubbed the form "tide_webform_content_rating" response with "modules/webform/content-rating-form-failure" fixture
    And I visit the page "/"
    And I enter the following into the content rating form:
      | helpful | comment                |
      | Yes     | this is a test comment |
