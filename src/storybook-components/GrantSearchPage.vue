  ...
  <rpl-base-layout class="event-search-page-demo">
    ...
    >
      <template slot="aboveContent">
        <rpl-search-form
          :title="mock.grantSearchForm.title"
          :searchPlaceholder="mock.grantSearchForm.searchPlaceholder"
          :filterForm="mock.grantSearchForm.filterForm"
          :theme="mock.grantSearchForm.theme"
      ...
      <div>
        <rpl-search-results
          :searchResults="noResults ? [] : mock.grantSearchResultItems"
