        ...
        <a
         ...
         target="_blank">
          ...
          <div class="rpl-file__info">
            <span class="rpl-file__name rpl-type-p rpl-type-weight-bold rpl-u-focusable rpl-u-focusable--inline" tabindex="0">This is an example of a document title</span>
