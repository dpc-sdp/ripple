...
Feature: Basic Page
  ...
  Scenario: 8-FE-page-2 View Basic Page 
    ...
    # wysiwyg	
    And the order number 1 wysiwyg content contains fixture "core/snippets/callout"
    And the order number 1 wysiwyg content contains fixture "core/snippets/blockquote"
