Feature: News page
  ...
  Scenario: BE - Creating a news page
    ...
    And in the backend there is a node at "/test-news-page" with "modules/news/news-1" data
    And in the backend there is a node at "/test-news-page-2" with "modules/news/news-2" data
