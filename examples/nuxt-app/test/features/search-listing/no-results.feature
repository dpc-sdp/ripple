Feature: No results
  ...
  Example: Empty response
    ...
    And the no results component should be display "Sorry! We couldn't find any matches"
  ...
  Example: Empty response with custom component
    ...
    Then the search listing page should have 0 results
    And the no results component should be display "This is a custom component"
