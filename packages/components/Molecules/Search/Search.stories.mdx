...
## Search result wrapped in RplSearchResultsLayout
...
## Search results wrapped in RplSearchResultsLayout with RplCardProfile content
...
## Search result wrapped in RplSearchResultsLayout with RplSearchResultsTable content
