...
<Canvas>
  <Story
    ...
    args={{
      ...
      items: [
        { id: '1', text: 'First level A', href: '#', items: [
          { id: '2', text: 'Second level A', href: '#', items: [
            { id: '3', text: 'Third level A link with some text that will need to wrap', href: '#', items: [
              { id: '4', text: 'Fourth level A', href: '#' }
            ]}
          ]},
        ...
        { id: '20', text: 'First level B will go over two lines', href: '#', items: [
          { id: '21', text: 'Second level', href: '#', items: [
            { id: '22', text: 'Third level link with some text that will need to wrap', href: '#', items: [
              { id: '23', text: 'Fourth level', href: '#' }
            ]}
          ]},
        ...
        { id: '27', text: 'First level D', href: '#', items: [
          { id: '28', text: 'Second level', href: '#', items: [
            { id: '29', text: 'Third level link with some text that will need to wrap', href: '#', items: [
              { id: '30', text: 'Fourth level', href: '#' }
            ]}
          ]},
