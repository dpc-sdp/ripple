...
import VicGovLogo from '@dpc-sdp/ripple-ui-shared/assets/logos/logo-victoria-state-government.svg?component'
import {
  ICoreLink,
  ILogoLink,
  INavSectionItem,
...
<style src="@dpc-sdp/ripple-ui-styles/components/footer/RplFooter.css" />
