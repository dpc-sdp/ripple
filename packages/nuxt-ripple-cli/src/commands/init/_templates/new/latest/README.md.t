...
For documentation using the Ripple design system please see: https://ripple-docs.netlify.app/.
...
If you are working on a different backend site you will need to set the following environment variables (the values of which should have been provided in onboarding) :
