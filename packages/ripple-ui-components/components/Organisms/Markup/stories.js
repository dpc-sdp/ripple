...
storiesOf('Organisms/Markup', module)
  ...
  .add('Markup/Button', withReadme(readme, () => ({
    components: { RplMarkup },
    template: `<rpl-markup :html="html" />`,
    data () {
      return {
  ...
  .add('Markup/Iframe', withReadme(readme, () => ({
    components: { RplMarkup },
    template: `<rpl-markup :html="html" />`,
    data () {
      return {
  ...
  .add('Markup/Embedded video', withReadme(readme, () => ({
    components: { RplMarkup },
    template: `<rpl-markup :html="html" />`,
    data () {
      return {
  ...
  .add('Markup/Image', withReadme(readme, () => ({
    components: { RplMarkup },
    template: `<rpl-markup :html="html" />`,
    data () {
      return {
  ...
  .add('Markup/Link', withReadme(readme, () => ({
    components: { RplMarkup },
    template: `<rpl-markup :html="html" />`,
    data () {
      return {
  ...
  .add('Markup/Quotation', withReadme(readme, () => ({
    components: { RplMarkup },
    template: `<rpl-markup :html="html" />`,
    data () {
      return {
  ...
  .add('Markup/Embedded document', withReadme(readme, () => ({
    components: { RplMarkup },
    template: `<rpl-markup :html="html" />`,
    data () {
      return {
  ...
  .add('Markup/Tables', withReadme(readme, () => ({
    components: { RplMarkup },
    template: `<rpl-markup :html="html" />`,
    data () {
      return {
