...
::DocsExample
---
id: core-containers-content--callout&globals=theme:docsTheme1
---
::
...
> WCAG 2.0 Criterion 1.4.1 Use of Color: Color is not used as the only visual means of conveying information, indicating an action, prompting a response, or distinguishing a visual element. (Level A)
