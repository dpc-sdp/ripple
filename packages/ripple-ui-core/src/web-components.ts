...
import { default as RplPrimaryCampaignCmp } from './components/campaign-banner/primary-campaign.vue'
import { default as RplSecondaryCampaignCmp } from './components/campaign-banner/secondary-campaign.vue'
...
import { default as RplFooterCmp } from './components/footer/footer.vue'

import { default as RplHeaderCmp } from './components/header/header.vue'
import { default as RplHeroHeaderCmp } from './components/header/hero-header.vue'
import { default as RplIntroHeaderCmp } from './components/header/intro-header.vue'
...
import { default as RplImageCmp } from './components/image/image.vue'

import { default as RplInPageNavigationCmp } from './components/in-page-navigation/in-page-navigation.vue'

import { default as RplLayoutCmp } from './components/layout/layout.vue'
import { default as RplPageComponentCmp } from './components/layout/page-component.vue'
import { default as RplSidebarComponentCmp } from './components/layout/sidebar-component.vue'
...
import { default as RplSearchBarCmp } from './components/search-bar/search-bar.vue'
import { default as RplSocialShareCmp } from './components/social-share/social-share.vue'

import { default as RplStatsGridCmp } from './components/stats-grid/stats-grid.vue'
import { default as RplStatsGridItemCmp } from './components/stats-grid/stats-grid-item.vue'
