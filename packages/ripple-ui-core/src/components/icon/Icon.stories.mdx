...
const customIconNames = ['icon-accessible', 'icon-add', 'icon-arrow-down', 'icon-arrow-left', 'icon-arrow-right', 'icon-arrow-up', 'icon-attach', 'icon-browser', 'icon-calendar-lined', 'icon-cancel-circle-filled', 'icon-car', 'icon-check', 'icon-child-lined', 'icon-dollar-circle-filled', 'icon-fire', 'icon-flood', 'icon-free', 'icon-indent', 'icon-instagram', 'icon-lightning', 'icon-link', 'icon-linkedin', 'icon-list', 'icon-loading',
'icon-log-in-lined', 'icon-mail-lined', 'icon-medical', 'icon-menu', 'icon-microphone', 'icon-pause-circle-lined', 'icon-person', 'icon-play-circle-lined', 'icon-print-lined', 'icon-question-circle-lined', 'icon-search', 'icon-senior', 'icon-share', 'icon-smoke', 'icon-spotify', 'icon-star', 'icon-stop-circle-lined', 'icon-table-lined', 'icon-temperature', 'icon-traffic', 'icon-trash-lined', 'icon-twitter', 'icon-upload',
'icon-user-circle-filled', 'icon-video', 'icon-view', 'icon-wechat', 'icon-youtube', 'icon-zoom-in', 'icon-zoom-out']
...
export const CoreGalleryTemplate = (args) => ({
  components: { RplIcon },
  setup() {
    const icons = RplIconSprite.iconNames
    return { args, icons }
  },
...
<Canvas>
  <Story name="Core Sprite" argTypes={{
    theme: {
      control: { type: 'select' },
...
<Canvas>
  <Story name="On demand icons" argTypes={{
    theme: {
      control: { type: 'select' },
      options: ['core', 'accent', 'neutral'],
      defaultValue: 'core'
...
<Canvas>
  <Story name="Icon props" argTypes={{
    theme: {
      control: { type: 'select' },
      options: ['core', 'accent', 'neutral'],
      defaultValue: 'core'
    ...
    name: {
      control: { type: 'select' },
      defaultValue: RplIconSprite.iconNames[0],
      options: [...RplIconSprite.iconNames, ...customIconNames]
    },
    size: {
      control: { type: 'select' },
      defaultValue: 's',
...
<Canvas>
  <Story name="Custom icons" argTypes={{
    theme: {
      control: { type: 'select' },
      options: ['core', 'accent', 'neutral'],
      defaultValue: 'core'
