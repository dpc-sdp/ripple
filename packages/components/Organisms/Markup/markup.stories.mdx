...
## Call out
export const htmlCallout = `
<div class="callout-wrapper">
  <div class="callout-wrapper__title">Lorem ipsum dolor</div>
  <div class="callout-wrapper__content">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</div>
</div>
`

<Preview>
  <Story name="Callout" height="250px">
    {
      {
        components: { RplMarkup },
        template: `<rpl-markup :html="html" />`,
