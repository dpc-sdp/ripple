...
>
> This documentation site is about the Ripple UI component libraries, and there is a lot more to developing a site on the Single Digital Presence (SDP) stack that is not covered here.
> 
> For information about using Ripple in SDP sites, visit [support for SDP developers](/design-system/develop/sdp-support)

## Accessing the Source code

Ripple 2 is an open source project and the source code can be found in the [ripple monorepo on Github](https://github.com/dpc-sdp/ripple).

This monorepo contains a lot more than just the UI libraries so we've provided direct links to packages below:
- [View `ripple-ui-core` on Github](https://github.com/dpc-sdp/ripple/tree/main/packages/ripple-ui-core)
- [View `ripple-ui-forms` on Github](https://github.com/dpc-sdp/ripple/tree/main/packages/ripple-ui-forms)
