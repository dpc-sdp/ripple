Feature: Publication page page
  ...
  Background:
    And the endpoint "/api/tide/page" with query "?path=/demo-publication/demo-publication-chapter-1&site=8888" returns fixture "/publication-page/sample-publication-page" with status 200
  ...
  @mockserver
  Example: On load
    Given I visit the page "/demo-publication/demo-publication-chapter-1"
