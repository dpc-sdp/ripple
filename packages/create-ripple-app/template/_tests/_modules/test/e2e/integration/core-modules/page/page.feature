...
Feature: Basic Page
  ...
  Scenario: 8-FE-page-2 View Basic Page 
    ...
    # #Body	
    And the order number 1 wysiwyg content contains fixture "/snippets/FE-examplebody"
    # # Related Links
    ...
    And the related links should contain the following links:
      | title                             | url                                                   | target   |
      | Related Link external  text       | https://emergency.vic.gov.au/respond/#                | external |
      | Department of Premier and  Cabinet | https://www.vic.gov.au/department-premier-and-cabinet | external |
    # Whats Next
    ...
    And the whats next links should be:
      | title                                  | url                                                    | target   |
      | State Government of  Victoria           | https://www.vic.gov.au                                | external |             
      | Department of Premier and  Cabinet      | https://www.vic.gov.au/department-premier-and-cabinet | external |
    # Share this
