...
<style lang="scss">
  ...
  $rpl-hero-banner-title-color: $rpl-theme-hero-banner-title-color !default;
  $rpl-hero-banner-title-background-color: $rpl-theme-hero-banner-title-background-color !default;
