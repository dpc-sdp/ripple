Feature: Events
  ...
  Scenario: Event Page loads correctly
    ...
    And the Dates list item 1 should be "20 May 2019 11:02 am - 13 May 2020 11:11 am"
    And the Address list item 2 should be "45 Collins St,  Melbourne, VIC 3000"
    And the Price list item 3 should be "34.33 - 89.95"
    And the Web url list item 4 should be "https://www.weatherzone.com.au/vic/central/healesville"
    And the Requirements the list item 5 should be "Accessible venue"
