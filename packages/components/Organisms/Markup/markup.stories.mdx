...
<div class="rpl-markup__table">
  <table><caption>This is the table caption</caption> <thead><tr><th class="rpl-table--col2">Column 1</th> <th class="rpl-table--col2">Column 2</th> <th class="rpl-table--col6">Column 3 has quite a long heading</th> <th class="rpl-table--col2">Column 4<br>
  $000</th>
  </tr>
  </thead>
  <tbody>
...
`rpl-table--col1`, `rpl-table--col2`, `rpl-table--col3`, ... `rpl-table--col12`
