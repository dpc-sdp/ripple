        ...
        <a
         ...
         target="_blank">
          ...
          <div class="rpl-document__info">
            <span class="rpl-document__name rpl-type-p rpl-type-weight-bold rpl-u-focusable-line" tabindex="0">This is an example of a document title</span>
            <div class="rpl-document__meta rpl-type-label-small">
      ...
      <figure class="rpl-document">
        <a
         ...
         target="_blank">
          ...
          <div class="rpl-document__info">
            <span class="rpl-document__name rpl-type-p rpl-type-weight-bold rpl-u-focusable-inline" tabindex="0">This is an example of a document title</span>
            <div class="rpl-document__meta rpl-type-label-small">
              <span class="rpl-file__type">PDF</span>
              <span class="rpl-file__size">1.5 mb</span>
