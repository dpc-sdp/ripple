...
The [Ripple design system](https://www.vic.gov.au/ripple-design-system) is open source and released under an Apache 2.0 License.
...
- Check existing the [discussions](https://github.com/dpc-sdp/ripple/discussions) and [issues](https://github.com/dpc-sdp/ripple/issues) to see if the issue has already been discussed.
- Fill out the [bug report issue template](https://github.com/dpc-sdp/ripple/issues/new?assignees=dylankelly&labels=bug&template=bug_report.yml&title=[BUG])
...
- Log in to GitHub
- [Log an issue on the GitHub Repository](https://github.com/dpc-sdp/ripple/issues/new?assignees=dylankelly&labels=docs&template=docs.yml&title=[DOCS])
...
For development partners wishing to propose a new feature to Ripple please do the following:

- Check existing the [discussions](https://github.com/dpc-sdp/ripple/discussions/categories/feature-proposals-rfc) and [issues](https://github.com/dpc-sdp/ripple/issues) to see if the proposal has already been discussed. The discussion board is a great place to bring up new ideas for discussion without having to write up a full proposal.
- If you are confident that the feature is something worth progressing, please fill out the [New feature proposal](https://github.com/dpc-sdp/ripple/issues/new?assignees=dylankelly&labels=bug&template=feature-request.yml&title=[PROPOSAL])
