...
import RplComplaintsOverview from './ComplaintsOverview.vue'
...
storiesOf('Organisms/Complaints', module)
  .addDecorator(withKnobs)
  .add('Default', () => ({
    components: { RplComplaintsOverview },
    template: `<rpl-complaints-overview :title="title" :funding="funding" :audience="audience" :startdate="startdate" :enddate="enddate" :description="description" :link="link" :listing="listing" />`,
    props: {
      title: {
