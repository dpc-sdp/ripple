...
Nuxt layers allow you to easily extend default files, configs, and add new functionality to your Nuxt application.

See https://nuxt.com/docs/getting-started/layers for more details.
