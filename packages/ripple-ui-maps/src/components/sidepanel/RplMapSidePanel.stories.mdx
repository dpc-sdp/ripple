...
export const Template = (args) => ({
  components: { RplMap, RplMapProviderVicMap, RplMapSidePanel, RplMapSidePanelItem, RplMapSidePanelPagination, RplMapSidePanelCount, RplAccordion, RplIcon },
  setup() {
